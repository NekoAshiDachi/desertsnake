...
def upgrade():
    ...
    op.create_foreign_key('tech_glossary_fk', 'tech', 'glossary', ['glossary_id'], ['id'])
    op.create_foreign_key('tech_person_fk', 'tech', 'person', ['person_id'], ['id'])
    op.create_foreign_key('tech_video_fk', 'tech', 'video', ['video_id'], ['id'])
    op.create_foreign_key('tech_publication_fk', 'tech', 'publication', ['pub_id'], ['id'])
...
def downgrade():
    ...
    op.drop_constraint('tech_publication_fk', 'tech', type_='foreignkey')
    op.drop_constraint('tech_video_fk', 'tech', type_='foreignkey')
    op.drop_constraint('tech_person_fk', 'tech', type_='foreignkey')
    op.drop_constraint('tech_glossary_fk', 'tech', type_='foreignkey')
